...
extension Property {
    ...
    public struct Kind: RawRepresentable, Hashable {
        public typealias RawValue = icalproperty_kind
        public let rawValue: icalproperty_kind
        public init(rawValue: icalproperty_kind) {
...
extension Property.Kind {
    ...
    /// Array<Property.Kind>
    public static var allCases: Array<Property.Kind> {
        return [ANY, ACCEPTRESPONSE, ACKNOWLEDGED, ACTION, ALLOWCONFLICT, ATTACH, ATTENDEE, BUSYTYPE, CALID, CALMASTER, CALSCALE, CAPVERSION,
                CARLEVEL, CARID, CATEGORIES, CLASS, CMD, COLOR, COMMENT, COMPLETED, COMPONENTS, CONFERENCE, CONTACT, CREATED, CSID, DATEMAX,
                DATEMIN, DECREED, DEFAULTCHARSET, DEFAULTLOCALE, DEFAULTTZID, DEFAULTVCARS, DENY, DESCRIPTION, DTEND, DTSTAMP, DTSTART, DUE,
                DURATION, ESTIMATEDDURATION, EXDATE, EXPAND, EXRULE, FREEBUSY, GEO, GRANT, IMAGE, ITIPVERSION, LASTMODIFIED, LOCATION,
                MAXCOMPONENTSIZE, MAXDATE, MAXRESULTS, MAXRESULTSSIZE, METHOD, MINDATE, MULTIPART, NAME, ORGANIZER, OWNER, PATCHDELETE,
                PATCHORDER, PATCHPARAMETER, PATCHTARGET, PATCHVERSION, PERCENTCOMPLETE, PERMISSION, POLLCOMPLETION, POLLITEMID, POLLMODE,
                POLLPROPERTIES, POLLWINNER, PRIORITY, PRODID, QUERY, QUERYLEVEL, QUERYID, QUERYNAME, RDATE, RECURACCEPTED, RECUREXPAND, RECURLIMIT,
                RECURRENCEID, REFRESHINTERVAL, RELATEDTO, RELCALID, REPEAT, REPLYURL, REQUESTSTATUS, RESOURCES, RESPONSE, RESTRICTION, RRULE, SCOPE,
                SEQUENCE, SOURCE, STATUS, STORESEXPANDED, SUMMARY, TARGET, TASKMODE, TRANSP, TRIGGER, TZID, TZIDALIASOF, TZNAME, TZOFFSETFROM,
                TZOFFSETTO, TZUNTIL, TZURL, UID, URL, VERSION, VOTER, X, XLICCLASS, XLICCLUSTERCOUNT, XLICERROR, XLICMIMECHARSET, XLICMIMECID,
                XLICMIMECONTENTTYPE, XLICMIMEENCODING, XLICMIMEFILENAME, XLICMIMEOPTINFO]
    }
}
